...
public class OrderHelperTests {
	...
	expected.add(new Position(456, 6, "NFLX", LocalDate.of(2020, 10, 16), false, BigDecimal.valueOf(600),
		OptionType.CALL));
	testOrder(actual, expected, "BACKRATIO", "NFLX", "@.05db");
	...
	expected.add(new Position(455, -12, "QQQ", LocalDate.of(2020, 10, 16), false, BigDecimal.valueOf(290),
		OptionType.CALL));
	testOrder(actual, expected, "BACKRATIO", "QQQ", "@-.52db");
    }
	...
	expected.add(new Position(462, 1, "SPX", LocalDate.of(2020, 10, 28), false, BigDecimal.valueOf(3540),
		OptionType.CALL));
	testOrder(actual, expected, "BUTTERFLY", "SPX", "@-.90cr");
	...
	expected.add(new Position(431, -2, "TSLA", LocalDate.of(2020, 9, 4), false, BigDecimal.valueOf(680),
		OptionType.CALL));
	testOrder(actual, expected, "BUTTERFLY", "TSLA", "@-.10db");
    }
	...
	expected.add(new Position(441, 2, "SPX", LocalDate.of(2020, 9, 18), false, BigDecimal.valueOf(3555),
		OptionType.CALL));
	testOrder(actual, expected, "CONDOR", "SPX", "@-.95cr");
	...
	expected.add(new Position(400, -1, "AAPL", LocalDate.of(2020, 7, 10), false, BigDecimal.valueOf(377.5),
		OptionType.CALL));
	testOrder(actual, expected, "CONDOR", "AAPL", "@1.28");
    }
	...
	expected.add(new Position(436, 2, "UVXY", LocalDate.of(2020, 9, 25), false, BigDecimal.valueOf(19.5),
		OptionType.PUT));
	testOrder(actual, expected, "DIAGONAL", "UVXY", "@-.25db");
	...
	testOrder(actual, expected, "DIAGONAL", "GLD", "@-.42db");
    }
	...
	expected.add(new Position(467, 1, "AAPL", LocalDate.of(2020, 10, 30), false, BigDecimal.valueOf(109),
		OptionType.PUT));
	testOrder(actual, expected, "IRON CONDOR", "AAPL", "@.80");
	...
	testOrder(actual, expected, "IRON CONDOR", "FB", "@2.09");
    }
	...
	expected.add(new Position(414, 2, "GLD", LocalDate.of(2020, 10, 9), false, BigDecimal.valueOf(184),
		OptionType.CALL));
	testOrder(actual, expected, "CALL", "GLD", "@.32");
	...
	expected.add(new Position(414, -4, "GLD", LocalDate.of(2020, 11, 6), false, BigDecimal.valueOf(172),
		OptionType.PUT));
	testOrder(actual, expected, "PUT", "GLD", "@.38");
    }
	...
	expected.add(new Position(424, 4, "SPX", LocalDate.of(2020, 8, 21), false, BigDecimal.valueOf(3450),
		OptionType.CALL));
	testOrder(actual, expected, "~BUTTERFLY", "SPX", "@.80");
	...
	expected.add(new Position(423, -2, "SPX", LocalDate.of(2020, 8, 17), false, BigDecimal.valueOf(3415),
		OptionType.CALL));
	testOrder(actual, expected, "~BUTTERFLY", "SPX", "@3.00");
    }
	...
	expected.add(new Position(458, -1, "SPX", LocalDate.of(2020, 10, 21), false, BigDecimal.valueOf(3365),
		OptionType.PUT));
	testOrder(actual, expected, "VERTICAL", "SPX", "@1.45");
	...
	expected.add(new Position(426, 2, "BABA", LocalDate.of(2020, 9, 4), false, BigDecimal.valueOf(285),
		OptionType.CALL));
	testOrder(actual, expected, "VERTICAL", "BABA", "@2.50");
    }

    @Test
    public void twoTest() throws Exception {
	String test1 = "#527 NEW WORKING SELL -2 RIOT 22 JAN 21 16 PUT @.30 LMT & BUY +1 BUTTERFLY RIOT 22 JAN 21 25/30/35 CALL @.65 LMT 1 and 2 units to start, let's see if any of this fills before committing further.";
	...
	expected2.add(new Position(527, 1, "RIOT", LocalDate.of(2021, 1, 22), false, BigDecimal.valueOf(35),
		OptionType.CALL));
	testOrder(actual.get(0), expected, "PUT", "RIOT", "@.30");
	testOrder(actual.get(1), expected2, "BUTTERFLY", "RIOT", "@.65");
	...
	expected2.add(new Position(414, -2, "GLD", LocalDate.of(2020, 11, 13), false, BigDecimal.valueOf(186.5),
		OptionType.CALL));
	testOrder(actual.get(0), expected, "PUT", "GLD", "@.38");
	testOrder(actual.get(1), expected2, "CALL", "GLD", "@.39");
    }

    @Test
    public void stopTest() throws Exception {
	String test1 = "#519 SELL -1 VERTICAL SPY 100 (Weeklys) 8 JAN 21 376/379 CALL STP 2.00 MARK Stop limit order on other unit. Not willing to gamble for that extra dollar into tomorrow (50/50 bet)";
	...
	testOrder(actual, expected, "VERTICAL", "SPY", "2.00", true, 0);
	...
	expected.add(new Position(520, -5, "TSLA", LocalDate.of(2021, 1, 15), false, BigDecimal.valueOf(1020),
		OptionType.CALL));
	testOrder(actual, expected, "CALL", "TSLA", ".65", true, 0);
    }

    @Test
    public void conditionTest() throws Exception {
	String test1 = "#465 BUY +1 SPX 30 OCT 20 3415 CALL STP WHEN SPX MARK AT OR ABOVE 3342.00";

	OrderModel actual = helper.createOrders(test1).get(0);
	List<Position> expected = new ArrayList<Position>();
	expected.add(new Position(465, 1, "SPX", LocalDate.of(2020, 10, 30), false, BigDecimal.valueOf(3415),
		OptionType.CALL));
	testOrder(actual, expected, "CALL", "SPX", "3342.00", true, 1);
	...
	expected.add(new Position(432, -1, "NFLX", LocalDate.of(2020, 9, 4), false, BigDecimal.valueOf(590),
		OptionType.CALL));
	testOrder(actual, expected, "BUTTERFLY", "NFLX", "550.00", false, -1);
    }

    private void testOrder(OrderModel actual, List<Position> expected, String spread, String symbol, String price) {
	testOrder(actual, expected, spread, symbol, price, false, 0);
    }

    private void testOrder(OrderModel actual, List<Position> expected, String spread, String symbol, String price,
	    boolean stop, int condition) {
	...
	Assertions.assertEquals(parsePrice(price), actual.getPriceBD(), "Wrong Order BigDecimal Price");
	...
	try {
	    ...
	    priceBD = new BigDecimal(StringUtils.substring(price, 0, StringUtils.indexOf(price, '.') + 3));
